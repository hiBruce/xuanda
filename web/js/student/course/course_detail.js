    ...
    var routes = [
        {path: '/', redirect: '/progress'},
        {
            ...
            component: function (res, rej) {
                require([__uri('/web/js/student/course/child/baseinfo.js')], res);
            }
        },
        {
            name: "teacherTeam",
            path: "/teacherTeam",
            component: function (res, rej) {
                require([__uri('/web/js/student/course/child/teacherTeam.js')], res);
            }
        },
        {
            name: "teachingSet",
            path: "/teachingSet",
            component: function (res, rej) {
                require([__uri('/web/js/student/course/child/teachingSet.js')], res);
            }
        },
        {
            name: "classManage",
            path: "/classManage",
            component: function (res, rej) {
                require([__uri('/web/js/student/course/child/classManage.js')], res);
            }
        },
        {
            name: 'studentList',
            ...
            component: function (res, rej) {
                require([__uri('/web/js/student/course/child/classManageStudentList.js')], res);
            }
        },
        {
            name: 'khbz',
            path: '/khbz',
            component: function (res, rej) {
                require([__uri('/web/js/student/course/child/bjgl/khbz.js')], res);
            }
        },
        {
            name: 'progress',
            path: '/progress',
            component: function (res, rej) {
                require([__uri('/web/js/student/course/child/xxjd/index.js')], res);
            }
        },
        {
            name: 'xscj',
            path: '/xscj',
            component: function (res, rej) {
                require([__uri('/web/js/student/course/child/bjgl/xscj.js')], res);
            }
        },
        {
            name: 'courseData',
            path: '/courseData',
            component: function (res, rej) {
                require([__uri('/web/js/student/course/child/add_source.js')], res);
            }
        },
        {
            name: 'courseMenu',
            path: '/courseMenu',
            component: function (res, rej) {
                require([__uri('/web/js/student/course/child/courseMenu.js')], res);
            }
        },
        {
            name: 'homework',
            path: '/homework',
            component: function (res, rej) {
                require([__uri('/web/js/student/course/child/homework/index.js')], res);
            }
        },
        {
            name: 'homework',
            path: '/homework/:id',
            component: function (res, rej) {
                require([__uri('/web/js/student/course/child/homework/detail.js')], res);
            }
        },
        {
            name: 'exam',
            path: '/exam/',
            component: function (res, rej) {
                require([__uri('/web/js/student/course/child/ks/index.js')], res);
            }
        },
        {
            name: 'quesetion',
            path: '/quesetion',
            component: function (res, rej) {
                require([__uri('/web/js/student/course/child/question/index.js')], res);
            }
        },
        {
            name: 'notes',
            path: '/notes',
            component: function (res, rej) {
                require([__uri('/web/js/student/course/child/notes/index.js')], res);
            }
        },
        {
            name: 'notice',
            path: '/notice',
            component: function (res, rej) {
                require([__uri('/web/js/student/course/child/notice/index.js')], res);
            }
        },
        {
            name: 'kcpj',
            path: '/kcpj',
            component: function (res, rej) {
                require([__uri('/web/js/student/course/child/kcpj/index.js')], res);
            }
        },
        {
            path: '/menu:index',
            component: function (res, rej) {
                require([__uri('/web/js/student/course/child/newMenu/index.js')], res);
            }
        },
        {
            ...
            component: function (res, rej) {
                require([__uri('/web/js/student/course/child/wdth/index.js')], res);
            }
        }
