...
define(['fcup'], function () {
    var question = Vue.component('question', {
        template: __inline("/web/html/student/course/child/question/index.html"),
        delimiters: ['{%', '%}'],
        data: function () {
            return {
                search: {
        ...
        methods: {
            createAns: function () {
                this.$modal.show(this, {
                    templateURL: __uri('/web/js/student/course/modal/modal_create_answer.js'),//必填
                    title: "新建答疑",//必填
                    row: this.course,
            ...
            getCourseDyInfo: function (page) {
                ...
                self.search.kcId = self.course.id;
