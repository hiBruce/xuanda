...
define(['fcup', 'Pagination'], function () {
    var notes = Vue.component('notes', {
        template: __inline("/web/html/student/course/child/notes/index.html"),
        delimiters: ['{%', '%}'],
        data: function () {
            return {
                orderBy: 'DCjsj',
        ...
        components: {
            'addnote': function (res, rej) {
                require([__uri('/web/js/student/course/create_note.js?v')], res);
            },
            'sc': function (res, rej) {
                require([__uri('/web/js/_layout_/sc/sc.js?v')], res);
            }
        },
        methods: {
