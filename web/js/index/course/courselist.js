    ...
    var course = new Vue({
        ...
        methods: {
            ...
            getUrl: function (items) {
                return (items.isPackage == 1) ? '/coursedetail/' + items.id : (((items.sourceType != 1) ? '/coursedetail/' + items.id : '/join_front?target_url=' + encodeURIComponent(items.sourceUrl) + '&app_key=' + APP_LNPT_KEY))
            },
            getUrl1: function (items) {
                //浙开
                return (items.isPackage == 1) ? '/coursedetail/' + items.id : (((items.sourceType != 1) ? '/coursedetail/' + items.id : '/join_front?target_url=' + encodeURIComponent(items.sourceUrl) + '&app_key=' + APP_ZK_KEY))
            }
        },
        created: function () {
