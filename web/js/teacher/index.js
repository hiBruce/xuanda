var organSettingsService = require ( '/web/component/service-organ-settings.js');
mod['index'] = new Vue({
    el: "#app",
    router: router,
    store: store,
    ...
    methods: {
        ...
        loadSettings : function (){
            var self = this;
            // 加载配置信息
            organSettingsService.loadOrganSettings().then(function (result){
                self.settings = result.data;
                self.$store.commit('setSettings', self.settings);
            });
        },
        getMenuTree: function () {
            var self = this;
            Service.get("/centro/admin/menu/getMyMenus", {type: 2}, function (result) {
