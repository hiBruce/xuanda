...
<div class="page" id="app">
    <div class="sd-wrapper course page-content">
        <div class="course-detail">
            <h3><a href="/courselist">课程</a> ><span>课程详情</span></h3>
                ...
                <div class="fl" v-cloak>
                    ...
                    <template v-if="loginStatus">
                        <a :href="'/course/detail/' + course.id" class="popLogin fl" v-if="learningStatus"
                           v-cloak>进入课程</a>
                        <div @click="joinCourse('/course/detail/' + course.id)" class="popLogin fl"
                             v-else-if="course.type==1" v-cloak>加入课程
                        </div>
                        <div class="sc-detail">
            ...
            <div class="main-l fl">
                ...
                <ul id="data_course" style="padding-bottom:20px;">
                    <li class="main-tabs catalog" id="data_course_outline_page">
                        <link rel="import" href="/web/html/index/course/course_outline.tpl?__inline"/>
                    </li>
...
<script src="/web/js/config.js" data-main="/web/js/index/course/coursedetail.js" id="entry"></script>
</body>
</html>