                ...
                <div class="dxt pro_wrap attend_exam_wrap" v-if="danxRow.length">
                    ...
                    <ul class="pro_list">
                        <li class="pro_li" v-for="(danx,index) in danxRow">
                            <h5>
                                <i class="fl" v-text="(index+1)+'、'"></i><span v-html="danx.mc"></span>
                                <i class="fix"></i>
                            </h5>
                ...
                <div class="dxt pro_wrap attend_exam_wrap" v-if="duoxRow.length">
                    ...
                    <ul class="pro_list">
                        <li class="pro_li" v-for="(duox,index) in duoxRow">
                            <h5>
                                <i class="fl" v-text="(index+1)+'、'"></i><span v-html="duox.mc"></span>
                                <i class="fix"></i>
                            </h5>
                            <ul class="options_list">
                ...
                <div class="pdt pro_wrap attend_exam_wrap" v-if="pandRow.length">
                    ...
                    <ul class="pro_list ">
                        <li class="pro_li" v-for="(pand,index) in pandRow">
                            <h5>
                                <i class="fl" v-text="(index+1)+'、'"></i><span v-html="pand.mc"></span>
                                <i class="fix"></i>
                            </h5>
                            <ul class="options_list">
                                <li>
                ...
                <div class="jdt pro_wrap attend_exam_wrap" v-if="zhugRow.length">
                    ...
                    <ul class="pro_list">
                        <li class="pro_li" v-for="(zhug,index) in zhugRow">
                            <h5>
                                <i class="fl" v-text="(index+1)+'、'"></i><span v-html="zhug.mc"></span>
                                <i class="fix"></i>
                            </h5>
...
<script src="/web/js/config.js" data-main="/web/organ/{{domain}}/course/exam/exercise.js" id="entry"></script>
</html>
